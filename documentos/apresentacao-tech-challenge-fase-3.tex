...
\begin{frame}{Contexto clínico com controle de risco}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{block}{Recuperação}
      \begin{itemize}
        \item Embeddings com \texttt{all-MiniLM-L6-v2} e busca vetorial com FAISS.
...
\begin{frame}{Arquitetura e fluxo RAG}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{tikzpicture}[node distance=0.12cm, every node/.style={font=\scriptsize},
      ...
      \node[flow] (t) {translate\_question: OpenAI API};
      ...
      \node[flow, below=of g] (a) {translate\_answer: OpenAI API};
      \node[flow, below=of a] (v) {review\_output: OpenAI API + fontes};
