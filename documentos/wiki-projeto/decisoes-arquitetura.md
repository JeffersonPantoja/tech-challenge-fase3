...
- O assistente médico da fase 2 carrega o modelo local completo gerado no notebook quando ele está disponível e o expõe via `HuggingFacePipeline` para integração com LangChain.
