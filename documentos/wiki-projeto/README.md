...
Memória ativa do projeto. Esta pasta concentra decisões, visão geral, convenções e manuais usados durante o desenvolvimento.
...
- [Decisões de Arquitetura](./decisoes-arquitetura.md)
...
- Atualizar esta wiki sempre que houver decisão importante.
- Manter os textos curtos, objetivos e fáceis de navegar.
