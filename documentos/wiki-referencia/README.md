...
Referências externas, materiais de estudo e documentos-base do projeto.

## Wiki ativa

- [Wiki do Projeto](../wiki-projeto/README.md)

## Aulas

- [Aula 01 - Preparando dados de treinamento para fine-tuning](./Fine-tuning-rag-para-documentos/Aula-01-Preparando-dados-de-treinamento-para-fine-tuning/README.md)
