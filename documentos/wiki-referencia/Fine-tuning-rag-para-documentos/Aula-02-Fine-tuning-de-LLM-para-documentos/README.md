# Aula 02 - Fine tuning de LLM para documentos
...
- Uso de ambiente Colab para execução.
- Instalação de dependências específicas para treino de modelo.
- Preparação do dataset para formato compatível com o modelo.
- Ajuste fino de um modelo de linguagem para resumir textos/documentos.
